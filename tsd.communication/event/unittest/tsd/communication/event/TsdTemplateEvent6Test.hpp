//////////////////////////////////////////////////////////////////////
/// @file TsdTemplateEvent6Test.hpp
/// @author piotr.brzyski@partner.preh.de
/// @brief Header file for Unit Tests to test TsdTemplateEvent6
///
/// Copyright (c) Preh Car Connect GmbH
/// CONFIDENTIAL
//////////////////////////////////////////////////////////////////////

#ifndef TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT6TEST_HPP
#define TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT6TEST_HPP
...
/**
 * Testclass for TsdTemplateEvent6
 *
 * @brief Testclass for TsdTemplateEvent6
 */
class TsdTemplateEvent6Test : public CPPUNIT_NS::TestFixture
{
public:
   /**
    * @brief Test scenario: with eventid
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::Constructor
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::Serialize
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::Clone
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::SetData1
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::SetData2
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::SetData3
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::SetData4
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::SetData5
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent6::SetData6
    * @tsd_testexpected new value set
    */
   void test_SetData6_SetNewValue_NewValueSet();

   CPPUNIT_TEST_SUITE(TsdTemplateEvent6Test);
...
#endif // TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT6TEST_HPP
