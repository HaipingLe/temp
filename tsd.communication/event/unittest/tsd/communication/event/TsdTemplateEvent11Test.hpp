//////////////////////////////////////////////////////////////////////
/// @file TsdTemplateEvent11Test.hpp
/// @author piotr.brzyski@partner.preh.de
/// @brief Header file for Unit Tests to test TsdTemplateEvent11
///
/// Copyright (c) Preh Car Connect GmbH
/// CONFIDENTIAL
//////////////////////////////////////////////////////////////////////

#ifndef TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT11TEST_HPP
#define TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT11TEST_HPP
...
/**
 * Testclass for TsdTemplateEvent11
 *
 * @brief Testclass for TsdTemplateEvent11
 */
class TsdTemplateEvent11Test : public CPPUNIT_NS::TestFixture
{
public:
   /**
    * @brief Test scenario: with eventid
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::Constructor
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::Serialize
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::Clone
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData1
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData2
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData3
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData4
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData5
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData6
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData7
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData8
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData9
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData10
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent11::SetData11
    * @tsd_testexpected new value set
    */
   void test_SetData11_SetNewValue_NewValueSet();

   CPPUNIT_TEST_SUITE(TsdTemplateEvent11Test);
...
#endif // TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT11TEST_HPP
