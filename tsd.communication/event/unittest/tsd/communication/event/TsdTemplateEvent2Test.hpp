//////////////////////////////////////////////////////////////////////
/// @file TsdTemplateEvent2Test.hpp
/// @author piotr.brzyski@partner.preh.de
/// @brief Header file for Unit Tests to test TsdTemplateEvent2
///
/// Copyright (c) Preh Car Connect GmbH
/// CONFIDENTIAL
//////////////////////////////////////////////////////////////////////

#ifndef TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT2TEST_HPP
#define TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT2TEST_HPP
...
/**
 * Testclass for TsdTemplateEvent2
 *
 * @brief Testclass for TsdTemplateEvent2
 */
class TsdTemplateEvent2Test : public CPPUNIT_NS::TestFixture
{
public:
   /**
    * @brief Test scenario: with eventid
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent2::Constructor
    * @tsd_testexpected object created
    */
   void test_Constructor_WithEventid_ObjectCreated();
   /**
    * @brief Test scenario: with event id and values
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent2::Constructor
    * @tsd_testexpected object created
    */
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent2::Serialize
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent2::Clone
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent2::SetData1
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent2::SetData2
    * @tsd_testexpected new value set
    */
   void test_SetData2_SetNewValue_NewValueSet();

   CPPUNIT_TEST_SUITE(TsdTemplateEvent2Test);
...
#endif // TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT2TEST_HPP
