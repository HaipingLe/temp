//////////////////////////////////////////////////////////////////////
/// @file TsdTemplateEvent14Test.hpp
/// @author piotr.brzyski@partner.preh.de
/// @brief Header file for Unit Tests to test TsdTemplateEvent14
///
/// Copyright (c) Preh Car Connect GmbH
/// CONFIDENTIAL
//////////////////////////////////////////////////////////////////////

#ifndef TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT14TEST_HPP
#define TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT14TEST_HPP
...
/**
 * Testclass for TsdTemplateEvent14
 *
 * @brief Testclass for TsdTemplateEvent14
 */
class TsdTemplateEvent14Test : public CPPUNIT_NS::TestFixture
{
public:
   /**
    * @brief Test scenario: with eventid
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::Constructor
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::Serialize
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::Clone
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData1
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData2
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData3
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData4
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData5
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData6
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData7
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData8
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData9
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData10
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData11
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData12
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData13
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent14::SetData14
    * @tsd_testexpected new value set
    */
   void test_SetData14_SetNewValue_NewValueSet();

   CPPUNIT_TEST_SUITE(TsdTemplateEvent14Test);
...
#endif // TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT14TEST_HPP
