//////////////////////////////////////////////////////////////////////
/// @file TsdTemplateEvent12Test.hpp
/// @author piotr.brzyski@partner.preh.de
/// @brief Header file for Unit Tests to test TsdTemplateEvent12
///
/// Copyright (c) Preh Car Connect GmbH
/// CONFIDENTIAL
//////////////////////////////////////////////////////////////////////

#ifndef TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT12TEST_HPP
#define TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT12TEST_HPP
...
/**
 * Testclass for TsdTemplateEvent12
 *
 * @brief Testclass for TsdTemplateEvent12
 */
class TsdTemplateEvent12Test : public CPPUNIT_NS::TestFixture
{
public:
   /**
    * @brief Test scenario: with eventid
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::Constructor
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::Serialize
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::Clone
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData1
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData2
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData3
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData4
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData5
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData6
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData7
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData8
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData9
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData10
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData11
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent12::SetData12
    * @tsd_testexpected new value set
    */
   void test_SetData12_SetNewValue_NewValueSet();

   CPPUNIT_TEST_SUITE(TsdTemplateEvent12Test);
...
#endif // TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT12TEST_HPP
