//////////////////////////////////////////////////////////////////////
/// @file TsdTemplateEvent5Test.hpp
/// @author piotr.brzyski@partner.preh.de
/// @brief Header file for Unit Tests to test TsdTemplateEvent5
///
/// Copyright (c) Preh Car Connect GmbH
/// CONFIDENTIAL
//////////////////////////////////////////////////////////////////////

#ifndef TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT5TEST_HPP
#define TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT5TEST_HPP
...
/**
 * Testclass for TsdTemplateEvent5
 *
 * @brief Testclass for TsdTemplateEvent5
 */
class TsdTemplateEvent5Test : public CPPUNIT_NS::TestFixture
{
public:
   /**
    * @brief Test scenario: with eventid
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::Constructor
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::Serialize
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::Clone
    ...
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::SetData1
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::SetData2
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::SetData3
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::SetData4
    * @tsd_testexpected new value set
    */
    ...
    * @brief Test scenario: set new value
    *
    * @tsd_testobject tsd::communication::event::TsdTemplateEvent5::SetData5
    * @tsd_testexpected new value set
    */
   void test_SetData5_SetNewValue_NewValueSet();

   CPPUNIT_TEST_SUITE(TsdTemplateEvent5Test);
...
#endif // TSD_COMMUNICATION_EVENT_TSDTEMPLATEEVENT5TEST_HPP
